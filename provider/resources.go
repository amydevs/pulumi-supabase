...
import (
	...
	supabase "github.com/iwahbe/terraform-provider-supabase/provider"

	"github.com/amydevs/pulumi-supabase/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(supabase.New(version.Version)()),
		...
		Keywords:   []string{"amydevs", "supabase", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/amydevs/pulumi-supabase",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/amydevs/pulumi-supabase/sdk/",
